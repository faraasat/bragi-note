      ...
      <main className="pt-32 pb-20">
        ...
        <section className="container mx-auto px-6 mb-32">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="holographic-card p-12">
              ...
              <h2 className="text-4xl font-bold mb-4 text-cyan-400">Did I Miss Anything?</h2>
              <p className="text-xl text-gray-300 mb-6">
                "I was sick / overwhelmed / busy — and now I'm lost."
              </p>
              <p className="text-gray-400 leading-relaxed">
                Upload meeting transcripts, Slack exports, or chat histories. Bragi Note analyzes what happened while you were away and tells you exactly what you need to know.
              </p>
            </div>
            
            <div className="space-y-6">
              <div className="glass p-6 rounded-xl border border-cyan-500/20">
                <h3 className="text-lg font-semibold text-cyan-300 mb-3">What It Returns</h3>
              ...
              <div className="glass p-6 rounded-xl border border-cyan-500/20">
                <h3 className="text-lg font-semibold text-cyan-300 mb-3">Perfect For</h3>
                <p className="text-gray-300">Students, remote workers, freelancers, managers, parents, and anyone who fears being left behind.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 space-y-6">
              <div className="glass p-6 rounded-xl border border-purple-500/20">
                <h3 className="text-lg font-semibold text-purple-300 mb-3">How It Works</h3>
                <ol className="space-y-3 text-gray-300">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>Select your intent: Calm, Professional, Kind but Firm, De-escalate Conflict</span>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              <div className="glass p-6 rounded-xl border border-purple-500/20">
                <h3 className="text-lg font-semibold text-purple-300 mb-3">Use Cases</h3>
                <p className="text-gray-300">Work emails, customer support, team communication, personal relationships, and any high-stakes messages.</p>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 holographic-card p-12">
              ...
              <h2 className="text-4xl font-bold mb-4 text-purple-400">Say It Better</h2>
              <p className="text-xl text-gray-300 mb-6">
                "I don't want to ruin this relationship."
              </p>
              <p className="text-gray-400 leading-relaxed">
                Avoid sending angry emails, passive-aggressive messages, or emotionally charged texts. AI fixes emotionally risky communication before you hit send.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 mb-32">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="holographic-card p-12">
              ...
              <h2 className="text-4xl font-bold mb-4 text-pink-400">Explain It Like I'm Stressed</h2>
              <p className="text-xl text-gray-300 mb-6">
                "I don't understand this important thing."
              </p>
              <p className="text-gray-400 leading-relaxed">
                Paste complex documents and get clear, calming explanations. No panic, no jargon—just what it means for you.
              </p>
            </div>
            
            <div className="space-y-6">
              <div className="glass p-6 rounded-xl border border-pink-500/20">
                <h3 className="text-lg font-semibold text-pink-300 mb-3">Document Types</h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start gap-3">
              ...
              <div className="glass p-6 rounded-xl border border-pink-500/20">
                <h3 className="text-lg font-semibold text-pink-300 mb-3">What You Get</h3>
                <p className="text-gray-300">Calm, simple explanations with "What this means for you" clarity—without the stress.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 text-center">
          <div className="holographic-card p-16 max-w-4xl mx-auto">
            ...
            <Link href="/signup">
              <Button size="lg" className="neon-glow-purple hover-lift text-lg px-12 py-6">
                Get Started Now
              </Button>
            </Link>
          </div>
