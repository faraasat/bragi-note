        ...
        <div className="container mx-auto px-6 max-w-md">
          <div className="holographic-card p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full neon-glow-purple text-lg py-6">
                Create Account
              </Button>
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-black/50 text-gray-400">Or sign up with</span>
                </div>
              </div>
          ...
          <div className="mt-12 grid gap-4">
            <div className="glass p-4 rounded-lg border border-cyan-500/20 flex items-center gap-3">
              ...
              <span className="text-sm text-gray-300">Free forever plan available</span>
            </div>
